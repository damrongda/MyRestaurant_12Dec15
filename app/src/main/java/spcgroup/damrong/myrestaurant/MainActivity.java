...
public class MainActivity extends AppCompatActivity {
    ...
    private void synJSONtoSQLite() {
        ...
        while (intTable <= 2) {
            ...
            String strJSON = null;
            String strURLuser = "http://swiftcodingthai.com/12dec/php_get_data_damrong.php";
            ...
            try {
                ...
                StringBuilder objStringBuilder = new StringBuilder(); // เป็นตัวตัดสินว่าจะต้องตัดข้อมูลมาเก็บไว้ใน Buffer มากเท่าไหร่
                String strLine = null;
    ...
    private void testerAddValue() {
        objManageTABLE.addValueToUser("user", "pass", "ดำรง");
