...
public class OrderListView extends AppCompatActivity {
    ...
    private void updateMySQL() {
        ...
        try {
            ...
            Toast.makeText(OrderListView.this,"Update Successful", Toast.LENGTH_SHORT).show(); // เหตุการณืสุดท้ายทำเสร็จแล้ว
        } catch (Exception e) {
    ...
    private void createSpinner() {
        ...
        deskSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            } // ถ้าไม่มีการเลือก Spinner โปรแกรมจะเอาลำดับที่ 0
        });
